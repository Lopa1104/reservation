...
if ($order && $order->get_type() !== 'reservation_payment') {
    ...
    if (!is_array($payment_schedule) || empty($payment_schedule)) {
        ?>
        <div><h4><?php esc_html_e('No payment schedule found.', 'woocommerce-deposits'); ?></h4></div>
        ...
        <table style="width:100%; text-align:left;">
            ...
            <tr>
                ...
                <th><?php esc_html_e('Date', 'woocommerce-deposits'); ?> </th>
                <th><?php esc_html_e('Payment method', 'woocommerce-deposits'); ?> </th>
                <th><?php esc_html_e('Status', 'woocommerce-deposits'); ?> </th>
                <th><?php esc_html_e('Amount', 'woocommerce-deposits'); ?> </th>
                <th><?php esc_html_e('Actions', 'woocommerce-deposits'); ?> </th>
