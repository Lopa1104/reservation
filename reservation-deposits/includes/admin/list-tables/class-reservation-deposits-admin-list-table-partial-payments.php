 ...
 */
class Reservation_Deposits_Admin_List_Table_Partial_Payments extends WC_Admin_List_Table {
     ...
     * @var string
     */
    protected $list_table_type = 'reservation_payment';
    ...
    protected function render_blank_state() {
        ...
        echo '<h2 class="woocommerce-BlankState-message">' . esc_html__( 'No partial payments found.', 'woocommerce-deposits' ) . '</h2>';
    ...
    public function define_columns( $columns ) {
        ...
        $show_columns['order_number']     = esc_html__( 'Partial Payment', 'woocommerce-deposits' );
    ...
    /**
     * Render columm: wcdp_parent_order.
     */
    ...
    public function bulk_admin_notices() {
        ...
        if ( 'edit.php' !== $pagenow || 'reservation_payment' !== $post_type || ! isset( $_REQUEST['bulk_action'] ) ) { // WPCS: input var ok, CSRF ok.
            return;
        }
    ...
    public function search_label( $query ) {
        ...
        if ( 'edit.php' !== $pagenow || 'reservation_payment' !== $typenow || ! get_query_var( 'reservation_payment_search' ) || ! isset( $_GET['s'] ) ) { // phpcs:disable  WordPress.Security.NonceVerification.NoNonceVerification
            return $query;
        }
    ...
    public function add_custom_query_var( $public_query_vars ) {
        $public_query_vars[] = 'reservation_payment_search';
    ...
    public function search_custom_fields( $wp ) {
        ...
        if ( 'edit.php' !== $pagenow || empty( $wp->query_vars['s'] ) || 'reservation_payment' !== $wp->query_vars['post_type'] || ! isset( $_GET['s'] ) ) { // phpcs:disable  WordPress.Security.NonceVerification.NoNonceVerification
            return;
        }
        ...
        if ( ! empty( $post_ids ) ) {
            ...
            $wp->query_vars['reservation_payment_search'] = true;
