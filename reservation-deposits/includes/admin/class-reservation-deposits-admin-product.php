 ...
 *
 */
class Reservation_Deposits_Admin_Product
{
    ...
    {
        ?>
        <li class="deposits_tab"><a href="#deposits_tab_data"><?php esc_html_e('Deposit', 'woocommerce-deposits'); ?></a>
        </li><?php
	...
	public function tab_options(){
        ...
        if( wcdp_checkout_mode() ){
            ...
            <div id="deposits_tab_data" class="panel woocommerce_options_panel">
                ...
                <h3> <?php esc_html_e('Checkout Mode enabled', 'woocommerce-deposits'); ?></h3>
                <p><?php esc_html_e('If you would like to collect deposit on product basis , please disable Checkout mode. ', 'woocomerce-deposits') ?>
                    <a
                            href="<?php echo get_admin_url(null, '/admin.php?page=wc-settings&tab=wc-deposits'); ?>"> <?php esc_html_e('Go to plugin settings', 'woocommerce-deposits') ?> </a>
                </p>
    ...
    function wc_deposits_second_payment_reminder()
    {
        ...
        <p>
            <b><?php esc_html_e('If you would like to send out second payment reminder emails to all orders containing this product on a specific date in the future, set a date below.', 'woocommerce-deposits'); ?></b>
        </p>
        <p> <?php esc_html_e('Next Reminder Date :', 'woocommerce-deposits') ?> <input type="text"
    ...
    public function product_bulk_edit_end()
    {
        ?>
        <label>
            <h4><?php esc_html_e('Deposit Options', 'woocommerce-deposits'); ?></h4>
        </label>
        <label>
        ...
        <div class="inline-edit-group">
            <label class="alignleft">
                <span class="title"><?php esc_html_e('Deposit Amount', 'woocommerce-deposits'); ?></span>
                <span class="input-text-wrap">
    ...
    function variation_override($loop, $variation_data, $variation)
    {
        ...
        <hr/>
        <strong><span> <?php esc_html_e('Deposit settings', 'woocommerce-deposits'); ?></span></strong>
        </p>
        <?php
